...
<body>
    ...
    <div class="container">
        <form id="contact" action="send_new_course.php" method="post">
            <h3>Добавить Курс</h3>
            <!-- <fieldset>
          <input placeholder="Текст вопроса" type="text" tabindex="1" name="first" id="quest" required autofocus>
            ...
            <fieldset>
                <select style="margin-left: 30%; width: 40%; text-align: center;" class="select" id="group-select" name="group">
            ...
            <input type="submit">
            <a href="menu.html" class="button" name="button" type="button">Назад</a>
        </form>
    </div>
</body>
