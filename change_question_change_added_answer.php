...
<body>
    ...
    <div class="container">
        <form id="contact" action='send_cnanged_scores.php?answ_id=<?php echo $_GET["answer_id"];?>&answ_text=<?php echo $_GET["answer_text"];?>' method="post">
            ...
            <a href="change_question_change_question.php" style="width: 20%; float: left; margin-top: 40%;" class="button10" id="ok">Ок</a>
            <a href="change_question_change_question.php" style="width: 20%; float:right; margin-top: 40%;" class="button10" id="back">Назад</a>
                       </fieldset>
        </form>
    </div>
