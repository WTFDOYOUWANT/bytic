  ...
  <body>
      ...
      <div class="container">
          <form id="contact" action="" method="post">
              ...
              <fieldset>
                  <select style="margin-left: 30%; width: 40%; text-align: center;" class="select" id="question-select">
              ...
              <fieldset style="margin-left: 7%;">
                  ...
                  <a href="menu.html" class="nav" id="back">Назад</a>
              </fieldset>
          </form>
      </div>
      <script>
